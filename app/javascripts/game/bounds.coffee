...
define 'game.Bounds', ->
  ...
  # that keeps a mob from moving, or the frame of the viewport, or the map
  # itself.
  #
  Bounds = meta.def
    x1: 0
    ...
    # Construct a new Bounds by specifying the width and height of the bounds
    # box and (optionally) the coordinates of its top-left corner.
    #
    ...
    # value - An integer. The `side` is set to the `value`, and the
    #         corresponding sides are moved accordingly.
    #
    # Example:
    #
    #   bounds.x1 = 20
    ...
    #
    # The intersection should be detected correctly whether these bounds are
    # taller or shorter than the given bounds. In other words, the following
    # case is detected as an intersection (1 is this, 2 is other):
    #
    #        1     2           1     2
    #             ____        ____
    #      ______|_   |   => |   _|_____
