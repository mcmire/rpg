(function() {
  ...
  (game = this.game).define('Background', function(name) {
    var Background;
    Background = this.meta.def(name, this.roles.assignable, this.roles.tickable, {
      ...
      load: function() {
        var color, ctx, height, tile, width, x1, y1, _i, _j, _len, _len2, _ref, _ref2, _ref3, _ref4, _ref5, _results;
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          _ref2 = _ref[_i], color = _ref2[0], (_ref3 = _ref2[1], x1 = _ref3[0], y1 = _ref3[1]), (_ref4 = _ref2[2], width = _ref4[0], height = _ref4[1]);
          ctx.fillStyle = color;
