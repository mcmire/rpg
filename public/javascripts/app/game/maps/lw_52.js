(function() {
  ...
  (game = this.game).define('lw_52', function(name) {
    var Block, imageCollection, img, mapCollection, spr, spriteCollection;
    ...
    return mapCollection.add('lw_52', 1024, 1024, function(fg, bg) {
      var eightStone;
