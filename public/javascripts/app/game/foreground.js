(function() {
  ...
  (game = this.game).define('Foreground', function(name) {
    var Foreground;
    Foreground = this.meta.def(name, this.roles.assignable, this.roles.tickable, {
      ...
      load: function() {
        ...
        return (_ref = this.onLoadCallback) != null ? _ref.call(this) : void 0;
      },
      unload: function() {
        this.$canvas = null;
