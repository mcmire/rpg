(function() {
  ...
  define('game.Enemy', function() {
    var DIRECTIONS, Enemy, Grob, meta;
    meta = require('meta');
    Grob = require('game.Grob');
    /* FIXME
    */
    ...
    Enemy.extend({
      ...
      _initFence: function() {
        return this.fence = require('game.Bounds').rect(100, 100, 300, 300);
      },
      _initBoundsOnMap: function() {
        var fn, self, util, _results;
        util = require('util');
        this._super();
        self = this;
        fn = function() {
      ...
      _chooseAnotherDirection: function() {
        var direction, util, validDirections;
        util = require('util');
      ...
      _chooseSequenceLength: function() {
        return this.sequenceLength = require('util').randomInt(40, 80);
      }
    });
    return Enemy;
  });
