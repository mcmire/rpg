(function() {
  ...
  (game = this.game).define('Enemy', function(name) {
    var DIRECTIONS, Enemy;
    DIRECTIONS = 'right down left up'.split(' ');
    Enemy = this.Grob.cloneAs(name);
    ...
    Enemy.extend({
      ...
      _initBoundsOnMap: function() {
        ...
        fn = function() {
          var x1, y1;
          x1 = game.util.randomInt(self.fence.x1, self.fence.x2);
          y1 = game.util.randomInt(self.fence.y1, self.fence.y2);
      ...
      _chooseAnotherDirection: function() {
        ...
        direction = game.util.capitalize(game.util.randomItem(validDirections));
        this.setState("" + this.direction + "To" + direction);
        return this._chooseSequenceLength();
      },
      _chooseSequenceLength: function() {
        return this.sequenceLength = game.util.randomInt(40, 80);
      }
    });
    return Enemy;
  });
